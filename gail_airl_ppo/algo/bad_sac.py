...
class BADSAC(Algorithm):
    ...
    def update_critic(self, states, actions, rewards, dones, next_states, writer):
        ...
        if self.learning_steps % 1000 == 0:
            writer.add_scalar("loss/critic1", loss_critic1.item(), self.learning_steps)
            writer.add_scalar("loss/critic2", loss_critic2.item(), self.learning_steps)
    ...
    def update_actor(self, states, writer):
        ...
        if self.learning_steps % 1000 == 0:
            ...
            writer.add_scalar("loss/alpha", loss_alpha.item(), self.learning_steps)
            writer.add_scalar("stats/alpha", self.alpha, self.learning_steps)
